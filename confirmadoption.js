...
function getQueryParams() {
  ...
  return {
    ...
    petBreed: params.get("breed") || "",
    petAge: params.get("age") || "",
    petDescription: params.get("description") || "",
  };
}

// Autofill form fields if parameters exist
window.onload = function () {
  const { petName, petBreed, petAge, petDescription } = getQueryParams();

  if (petName) document.getElementById("petName").value = petName;
  if (petBreed) document.getElementById("petBreed").value = petBreed;
  if (petAge) document.getElementById("petAge").value = petAge;
  if (petDescription) document.getElementById("petDescription").value = petDescription;
};
